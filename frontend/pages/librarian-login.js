...
export default function LibrarianLogin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Only allow librarian role
            if (data.role === 'librarian' || data.role === 'LIBRARIAN') {
            ...
            <div style={styles.loginBox}>
                ...
                <div style={styles.footer}>
                    <div style={styles.testCredentials}>
                        ...
                        <p style={styles.hint}>Username: librarian</p>
                        <p style={styles.hint}>Password: lib123</p>
                    </div>
                    <Link href="/librarian" style={styles.link}>
